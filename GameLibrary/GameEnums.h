...
debug_enum_value EnumValues[ENUM_VALUES_SIZE] = {
    ...
    {Debug_Type_element, "Element_None", 0},
    {Debug_Type_element, "Element_Fire", 1},
    {Debug_Type_element, "Element_Earth", 2},
    {Debug_Type_element, "Element_Water", 3},
    {Debug_Type_element, "Element_Ice", 4},
    {Debug_Type_element, "Element_Air", 5},
    {Debug_Type_element, "Element_Lightning", 6},
    {Debug_Type_element, "Element_Life", 7},
    {Debug_Type_element, "Element_Death", 8},
    {Debug_Type_element, "element_count", 9},
