...
void PushTetrahedronOutline(
    ...
    scale Size = Transform.Scale;
    v3 Position = Transform.Translation - V3(0.258819f * Size.X, 0.25f * sqrt2 / sqrt3 * Size.Y, 0.5f * Size.Z);

    v3* Vertices = (v3*)Result->Vertices;
    Vertices[0] = Position;
    Vertices[1] = Position + V3(0.0, 0.0, Size.Z);
    Vertices[2] = Position + 0.5f * V3(sqrt3 * Size.X, 0.0f, Size.Z);
    Vertices[3] = Position + V3(0.25f * sqrt3 * Size.X, sqrt2 / sqrt3 * Size.Y, 0.5f * Size.Z);
    ...
    Elements[5]  = VertexOffset + 3;
    Elements[6]  = VertexOffset + 1;
    Elements[7]  = VertexOffset + 2;
    Elements[8]  = VertexOffset + 1;
    Elements[9]  = VertexOffset + 3;
    Elements[10] = VertexOffset + 2;
...
void PushOctahedronOutline(
    ...
    v3* Vertices = (v3*)Result->Vertices;
    float HalfRoot2 = 0.5f * sqrt2;
    Vertices[0] = Position + V3(0.0f, HalfRoot2*Size.Y, Size.Z);
    Vertices[1] = Position + V3(Size.X, HalfRoot2*Size.Y, Size.Z);
    Vertices[2] = Position + V3(Size.X, HalfRoot2*Size.Y, 0.0f);
    Vertices[3] = Position + V3(0.0f, HalfRoot2*Size.Y, 0.0f);
    Vertices[4] = Position + 0.5f * V3(Size.X, 0.0f, Size.Z);
    Vertices[5] = Position + V3(0.5f*Size.X, sqrt2 * Size.Y, 0.5f*Size.Z);
    ...
    Elements[0]  = VertexOffset + 0;
    Elements[1]  = VertexOffset + 1;
    Elements[2]  = VertexOffset + 1;
    Elements[3]  = VertexOffset + 2;
    Elements[4]  = VertexOffset + 2;
    Elements[5]  = VertexOffset + 3;
    Elements[6]  = VertexOffset + 3;
    Elements[7]  = VertexOffset + 0;
    Elements[8]  = VertexOffset + 0;
    Elements[9]  = VertexOffset + 4;
    Elements[10] = VertexOffset + 1;
    Elements[11] = VertexOffset + 4;
    Elements[12] = VertexOffset + 2;
    Elements[13] = VertexOffset + 4;
    Elements[14] = VertexOffset + 3;
    Elements[15] = VertexOffset + 4;
    Elements[16] = VertexOffset + 0;
    Elements[17] = VertexOffset + 5;
    Elements[18] = VertexOffset + 1;
    Elements[19] = VertexOffset + 5;
    Elements[20] = VertexOffset + 2;
    Elements[21] = VertexOffset + 5;
    Elements[22] = VertexOffset + 3;
    Elements[23] = VertexOffset + 5;
}

void PushIcosahedronOutline(
    render_group* Group, 
    transform Transform, 
    color Color,
    float Order = SORT_ORDER_DEBUG_OVERLAY
    ...
    float NormalizingFactor = 0.5f * sqrtf(0.5f * (3.0f + sqrtf(5.0f)));

    float Sign1 = 1.0f;
    float Sign2 = 1.0f;
    for (int i = 0; i < 2; i++) {
        for (int j = 0; j < 2; j++) {
            Vertices[6*i + 3*j]     = Position + NormalizingFactor * V3(Sign1*Size.X,             Sign2*goldenRatio*Size.Y, 0);
            Vertices[6*i + 3*j + 1] = Position + NormalizingFactor * V3(0,                        Sign1*Size.Y,             Sign2*goldenRatio*Size.Z);
            Vertices[6*i + 3*j + 2] = Position + NormalizingFactor * V3(Sign1*goldenRatio*Size.X, 0,                        Sign2*Size.Z);

            Elements[nElements++] = VertexOffset + 6*i + 3*j;
            Elements[nElements++] = VertexOffset + 6*i + 3*j + 2;
    ...
    Elements[nElements++] = VertexOffset + 0; Elements[nElements++] = VertexOffset + 1;
    Elements[nElements++] = VertexOffset + 0; Elements[nElements++] = VertexOffset + 6;
    Elements[nElements++] = VertexOffset + 0; Elements[nElements++] = VertexOffset + 7;
    Elements[nElements++] = VertexOffset + 0; Elements[nElements++] = VertexOffset + 8;
    Elements[nElements++] = VertexOffset + 1; Elements[nElements++] = VertexOffset + 2;
    Elements[nElements++] = VertexOffset + 1; Elements[nElements++] = VertexOffset + 3;
    Elements[nElements++] = VertexOffset + 1; Elements[nElements++] = VertexOffset + 5;
    Elements[nElements++] = VertexOffset + 1; Elements[nElements++] = VertexOffset + 7;
    Elements[nElements++] = VertexOffset + 2; Elements[nElements++] = VertexOffset + 4;
    Elements[nElements++] = VertexOffset + 2; Elements[nElements++] = VertexOffset + 5;
    Elements[nElements++] = VertexOffset + 2; Elements[nElements++] = VertexOffset + 6;
    Elements[nElements++] = VertexOffset + 3; Elements[nElements++] = VertexOffset + 7;
    Elements[nElements++] = VertexOffset + 3; Elements[nElements++] = VertexOffset + 9;
    Elements[nElements++] = VertexOffset + 3; Elements[nElements++] = VertexOffset + 11;
    Elements[nElements++] = VertexOffset + 4; Elements[nElements++] = VertexOffset + 5;
    Elements[nElements++] = VertexOffset + 4; Elements[nElements++] = VertexOffset + 6;
    Elements[nElements++] = VertexOffset + 4; Elements[nElements++] = VertexOffset + 9;
    Elements[nElements++] = VertexOffset + 4; Elements[nElements++] = VertexOffset + 10;
    Elements[nElements++] = VertexOffset + 5; Elements[nElements++] = VertexOffset + 9;
    Elements[nElements++] = VertexOffset + 6; Elements[nElements++] = VertexOffset + 10;
    Elements[nElements++] = VertexOffset + 7; Elements[nElements++] = VertexOffset + 8;
    Elements[nElements++] = VertexOffset + 7; Elements[nElements++] = VertexOffset + 11;
    Elements[nElements++] = VertexOffset + 8; Elements[nElements++] = VertexOffset + 10;
    Elements[nElements++] = VertexOffset + 8; Elements[nElements++] = VertexOffset + 11;
    Elements[nElements++] = VertexOffset + 9; Elements[nElements++] = VertexOffset + 10;
    Elements[nElements++] = VertexOffset + 10; Elements[nElements++] = VertexOffset + 11;
}

void PushDodecahedronOutline(render_group* Group, transform Transform, color Color, float Order = SORT_ORDER_DEBUG_OVERLAY) {
    game_shader_pipeline* Shader = GetShaderPipeline(Group->Assets, Shader_Pipeline_World_Single_Color_ID);
    render_primitive_options Options = {};
    Options.Flags = DEPTH_TEST_RENDER_FLAG;
    render_primitive_command* Result = PushPrimitiveCommand(
    ...
    for (int i = 0; i < 2; i++) {
        for (int j = 0; j < 2; j++) {
            for (int k = 0; k < 2; k++) {
                Vertices[nVertices++] = Position + NormalizingFactor * V3(Sign1 * Size.X, Sign2 * Size.Y, Sign3 * Size.Z);

                Sign3 *= -1.0f;
            }
            Vertices[nVertices++] = Position + NormalizingFactor * V3(0, Sign1 * phi * Size.Y, Sign2 * goldenRatio * Size.Z);
            Vertices[nVertices++] = Position + NormalizingFactor * V3(Sign1 * goldenRatio * Size.X, 0, phi * Sign2 * Size.Z);
            Vertices[nVertices++] = Position + NormalizingFactor * V3(Sign1 * phi * Size.X, Sign2 * goldenRatio * Size.Y, 0);
    ...
    Elements[nElements++] = VertexOffset + 0; Elements[nElements++] = VertexOffset + 2;
    Elements[nElements++] = VertexOffset + 0; Elements[nElements++] = VertexOffset + 3;
    Elements[nElements++] = VertexOffset + 0; Elements[nElements++] = VertexOffset + 4;
    Elements[nElements++] = VertexOffset + 1; Elements[nElements++] = VertexOffset + 4;
    Elements[nElements++] = VertexOffset + 1; Elements[nElements++] = VertexOffset + 7;
    Elements[nElements++] = VertexOffset + 1; Elements[nElements++] = VertexOffset + 8;
    Elements[nElements++] = VertexOffset + 2; Elements[nElements++] = VertexOffset + 7;
    Elements[nElements++] = VertexOffset + 2; Elements[nElements++] = VertexOffset + 10;
    Elements[nElements++] = VertexOffset + 3; Elements[nElements++] = VertexOffset + 5;
    Elements[nElements++] = VertexOffset + 3; Elements[nElements++] = VertexOffset + 13;
    Elements[nElements++] = VertexOffset + 4; Elements[nElements++] = VertexOffset + 9;
    Elements[nElements++] = VertexOffset + 5; Elements[nElements++] = VertexOffset + 9;
    Elements[nElements++] = VertexOffset + 5; Elements[nElements++] = VertexOffset + 12;
    Elements[nElements++] = VertexOffset + 6; Elements[nElements++] = VertexOffset + 8;
    Elements[nElements++] = VertexOffset + 6; Elements[nElements++] = VertexOffset + 9;
    Elements[nElements++] = VertexOffset + 6; Elements[nElements++] = VertexOffset + 17;
    Elements[nElements++] = VertexOffset + 7; Elements[nElements++] = VertexOffset + 11;
    Elements[nElements++] = VertexOffset + 8; Elements[nElements++] = VertexOffset + 18;
    Elements[nElements++] = VertexOffset + 10; Elements[nElements++] = VertexOffset + 13;
    Elements[nElements++] = VertexOffset + 10; Elements[nElements++] = VertexOffset + 14;
    Elements[nElements++] = VertexOffset + 11; Elements[nElements++] = VertexOffset + 14;
    Elements[nElements++] = VertexOffset + 11; Elements[nElements++] = VertexOffset + 18;
    Elements[nElements++] = VertexOffset + 12; Elements[nElements++] = VertexOffset + 15;
    Elements[nElements++] = VertexOffset + 12; Elements[nElements++] = VertexOffset + 17;
    Elements[nElements++] = VertexOffset + 13; Elements[nElements++] = VertexOffset + 15;
    Elements[nElements++] = VertexOffset + 14; Elements[nElements++] = VertexOffset + 19;
    Elements[nElements++] = VertexOffset + 15; Elements[nElements++] = VertexOffset + 19;
    Elements[nElements++] = VertexOffset + 16; Elements[nElements++] = VertexOffset + 17;
    Elements[nElements++] = VertexOffset + 16; Elements[nElements++] = VertexOffset + 18;
    Elements[nElements++] = VertexOffset + 16; Elements[nElements++] = VertexOffset + 19;
}
...
void PushCollider(render_group* Group, collider Collider, transform T, color Color) {
    ...
    switch (Collider.Type) {
        ...
        case Cube_Collider: {
            scale Size = Scale(Collider.Cube.HalfWidth, Collider.Cube.HalfHeight, Collider.Cube.HalfDepth);
            transform T = Transform(Position);
            T.Scale = Size;
            PushCubeOutline(Group, T, Color);
        } break;
